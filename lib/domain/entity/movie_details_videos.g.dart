...
MovieDetailsVideos _$MovieDetailsVideosFromJson(Map<String, dynamic> json) =>
    MovieDetailsVideos(
      ...
      results: (json['results'] as List<dynamic>)
          .map((e) =>
              MovieDetailViedosResult.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
MovieDetailViedosResult _$MovieDetailViedosResultFromJson(
...
Map<String, dynamic> _$MovieDetailViedosResultToJson(
        MovieDetailViedosResult instance) =>
    <String, dynamic>{
